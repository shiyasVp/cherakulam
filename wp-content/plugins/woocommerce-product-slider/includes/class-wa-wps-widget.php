...
class WA_WPS_Widget extends WP_Widget {


	// constructor
	function __construct() {
			parent::__construct(false, $name = __('WPS Widget', 'wa_wps_widget') );
	}
...
function widget($args, $instance) {
   ...
   if( $slider_id ) {
      echo do_shortcode('[wa-wps id="'.$slider_id.'"]');
   }
   echo '</div>';
   echo $after_widget;
}
...
// register widget
add_action('widgets_init', create_function('', 'return register_widget("wa_wps_widget");'));