...
<div class="wa-wps-field">
<label for="shortcode_text_input"><?php _e('Your Shortcode:', 'wps'); ?> </label>
<input readonly="true" id="shortcode_text_input" type="text" class="widefat" name="" value="<?php echo esc_attr($shortcode); ?>" />
<span class="note"><?php _e('Copy and paste this shortcode into your Post, Page or Custom Post editor.', 'wps'); ?></span>
<div class="clear"></div>
<hr/>
<label for="php_shortcode_text_input"><?php _e('Your PHP Code:', 'wps'); ?> </label>
