			...
			array(
				...
				'control'	 => array(
					...
					'args'	 => array(
						...
						'type'		 => 'radio',
						'choices'	 => array( 'default' => __( 'Modern Grid', 'ecommerce-product-catalog' ), 'list' => __( 'Classic List', 'ecommerce-product-catalog' ), 'grid' => __( 'Classic Grid', 'ecommerce-product-catalog' ) )
					)
				)
			),
		);
