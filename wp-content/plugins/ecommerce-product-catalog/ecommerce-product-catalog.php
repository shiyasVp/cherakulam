...
if ( !class_exists( 'eCommerce_Product_Catalog' ) ) {
	...
	final class eCommerce_Product_Catalog {
		...
		public function implecode_register_admin_styles() {
			...
			wp_register_script( 'admin-scripts', AL_PLUGIN_BASE_PATH . 'js/admin-scripts.min.js' . ic_filemtime( AL_BASE_PATH . '/js/admin-scripts.min.js' ), array( 'jquery-ui-sortable', 'jquery-ui-tooltip', 'jquery-validate-add', 'wp-color-picker', 'jquery-ui-autocomplete', 'ic_chosen' ) );
